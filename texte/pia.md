...
Publikationsmethoden wie die Betreibung eines Blogs stellen, durch die fortlaufende Ergänzung durch regelmäßige Beiträge, sowie durch die Möglichkeit auf Leserreaktionen einzugehen, keine abgeschlossenen Werke dar. Auch wenn es technisch möglich ist die Beitäge digital zu archivieren und eventuell in einem Printmedium zu veröffentlichen, muss untersucht werden, ob die enthaltenen Themen überhaupt in ein anderes Medium übertragen werden können, da beispielsweise in Buchform Funktionen wie Leserkommentare synchron behandeln zu können wegfallen würden.


### 2. Unterschiede bei der Selbstpublizierung von digitalen und hybriden Inhalten

Eine kommerziellere Methode seine Inhalte ohne Verlagswesen der Öffentlichkeit zu präsentieren, ist die Einführung, der eigenen Publikation in das normierte Produktions- und Vertriebssystem.
...
die Zugänglichkeit der Erscheinungsform haben.", bedarf jedes Medium eine eigene ISBN. Beispielsweise kann ein Roman in Buchform auch mit identischem Inhalt als e-Book zum Download angeboten werden, welches dann unter einer anderen Registrierung laufen würde.
...
Solche Plattformen bieten überwiegend eine digitale Publikationsmöglichkeit über e-Book-Formate und PDF an. Anbieter wie Ruckzuckbuch, ePubli oder Tredition geben die zusätzlich Möglichkeit über Print on Demand (PoD), also wenn der eigentliche Buchdruck erst nach der Bestellung des Lesers erfolgt, eine hybride Veröffentlichung zu veranlassen.
