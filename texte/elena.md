...
Einleitung: Das Internet verspricht Freiheit von dem wie und was publiziert werden kann. Ist das wirklich so? Welche Einschränkungen gibt es? Welche offensichtlich, welche unoffensichtlich? Welche Konsequenzen hat das für den Autor?

1. Abhängigkeit von Algorithmen und Plattformen
a) Limitierung in der Reichweite / Eingeschränkte Zirkulation
b) Datenuntersuchung (der eigenen Leser) notwendig
Überleitung zu 2: Plattformen stehen unter Kontrolle von Unternehmen oder staatlicher Eliten

2. Limitierung durch die Regierung
a) Eingeschränkter Zugang und Zensur in den verschiedenen Ländern / Contentfilter
Überleitung zu 3: Autor zensiert sich selbst, um nicht zensiert zu werden

3. Selbstzensur / Limitierung durch den Autor selbst
a) Plagiatgefahr im Internet sehr hoch

Schluss: Nur vermeintliche Freiheit
